...
### E1. No Hardcoded Colors `[aesthetic]`
**Severity:** Error
...
### E2. No Tailwind Palette Colors `[aesthetic]`
**Severity:** Error
...
### E3. No Hardcoded Light/Dark Values `[aesthetic]`
**Severity:** Error
...
### E4. Font Family Compliance `[aesthetic]`
**Severity:** Error
...
### E5. Spacing Grid Alignment `[aesthetic]`
**Severity:** Warning
...
### E6. Elevation Hierarchy `[aesthetic]`
**Severity:** Warning
...
### E7. Typography Weight Consistency `[aesthetic]` `[craft]`
**Severity:** Warning
...
### E8. Transition on Interactive States `[aesthetic]`
**Severity:** Warning
...
### C2. Vertical Rhythm Break `[craft]`
**Severity:** Warning
...
### A8. Color-Only Information `[a11y]`
**Severity:** Warning
...
### A19. Missing Autocomplete on Identity Fields `[a11y]`
**Severity:** Suggestion
...
### V5. Content Reflow at 320px `[a11y]`
**Severity:** Warning
...
### V10. Text Spacing Tolerance `[a11y]`
**Severity:** Warning
...
### A21. Accessible Authentication `[a11y]`
**Severity:** Warning
...
### A24. Dragging Alternatives `[a11y]`
**Severity:** Warning
...
### M1. Native Dialog Preference `[a11y]`
**Severity:** Suggestion
...
### M2. Inert Background Content `[a11y]`
**Severity:** Warning
...
### M4. DOM vs Visual Order Mismatch `[a11y]`
**Severity:** Warning
...
### J1. Visual Hierarchy Clarity `[aesthetic]`
**Severity:** Warning
...
### J2. Color Accent Restraint `[aesthetic]`
**Severity:** Suggestion
...
### J3. Hover State Presence `[aesthetic]`
**Severity:** Suggestion
...
### J4. Empty/Loading/Error States `[a11y]`
**Severity:** Suggestion
...
├─ focus:outline-none without ring? → WARNING. Add focus-visible indicator.
├─ Color-only status? → WARNING. Add icon/text.
├─ No reduced-motion handling? → SUGGESTION. Add motion-safe prefix.
